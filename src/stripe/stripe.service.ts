...
// SERVICES
import { ChargeCustomerModel, CreateCardTokenModel, RefundCustomerChargeModel } from '@shared/src/stripe/stripeModel';
...
export class StripeService implements IStripeService {
	...
	public async chargeWithCreditCardAndInstallments(data, stripeCustomerId: string) {
		const paramsToCharge = {
	...
	public async refundCustomerCharge({ payment_intent, reason }: RefundCustomerChargeModel): Promise<Stripe.Response<Stripe.Refund>> {
		const params = {
